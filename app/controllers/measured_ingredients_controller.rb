  ...
  def create
    ...
    respond_to do |format|
      if @measured_ingredient.save
        format.html { redirect_to measured_ingredient_url(@measured_ingredient), notice: "Measured ingredient was successfully created." }
  ...
  def update
    respond_to do |format|
      if @measured_ingredient.update(measured_ingredient_params)
        format.html { redirect_to measured_ingredient_url(@measured_ingredient), notice: "Measured ingredient was successfully updated." }
